# DAIW (Digital AI Workspace) - Architecture Overview
...
```bash
pytest daiw/tests/test_music_theory.py
pytest daiw/tests/test_midi_handler.py
pytest daiw/tests/test_ai_controller.py
```
...
```bash
# Test OSC connection
pytest daiw/tests/integration/test_ableton_connection.py

# Test skill loading
pytest daiw/tests/integration/test_skill_loading.py
```
...
```bash
# Test MIDI
python daiw/audio/midi_handler.py

# Test music theory
python daiw/dynamic_tools/music_theory.py

# Test skill
python daiw/dynamic_tools/generated_skills/example_skill.py
```
